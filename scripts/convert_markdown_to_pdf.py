...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scripts/convert_markdown_to_pdf.py <markdown_file> [output_pdf]")
        print("\nExample:")
        print("  python scripts/convert_markdown_to_pdf.py docs/posts/substack_zoho_keyword_fallacy.md")
        sys.exit(1)
