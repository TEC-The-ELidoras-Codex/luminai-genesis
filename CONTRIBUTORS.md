...
- To contribute: fork, run tests, open a pull request with clear description and test results.

## Acknowledgments

- Thanks to early reviewers and community replicators for testing the SAR benchmark.
