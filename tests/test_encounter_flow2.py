...
spec = importlib.util.spec_from_file_location(
    "tec_book.erasure_combat",
    str(Path(__file__).resolve().parents[1] / "tec_book" / "erasure_combat.py"),
)
module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(module)
resolve_encounter = module.resolve_encounter

from tec_book.tec_litrpg_system import create_lumina, KaznakGhoul
