# 43North & Buffalo Network Outreach Templates
...
I'm Angelo Hurley, founder of **The Elidoras Codex** — Buffalo's first AI Ethics Lab.
...
- Empire State Development grant application in progress
...
**What I Need**:
Introduction to fractional CFO in your mentor network. Equity-based compensation (2-4%), cash when funded (Empire State Development decision expected March 2026).

**The Ask**:
15-minute call to discuss Buffalo AI ecosystem fit and CFO introductions.
...
**What I Need**:
Fractional CFO introduction. Equity now (2-4%), cash when Empire State grant hits (April 2026, 70%+ probability).
...
**Next Step**:
Can we schedule an intake meeting to discuss LaunchPad fit?
...
## LinkedIn Post: Public CFO Search

**Post Text**:

---

**Seeking Fractional CFO: Buffalo AI Ethics Lab (Equity-Based)**
...
**Tweet 2/5**:
The mission: TGCR (Theory of General Contextual Resonance)

AI alignment via geometric impossibility theorems.

When models are misaligned, math PROVES it. Not "probably." Provably.

This is the breakthrough Bostrom/Russell said we need.
...
Buffalo needs this win. We're it.
...
- Prep Y Combinator Summer 2026 app

10-15 hrs/week. Async-friendly.
...
## Reddit Post: r/Buffalo + r/startups

**Title**: [Buffalo, NY] Seeking Fractional CFO for AI Ethics Startup (Equity-Based)

**Body**:

---

Hey Buffalo (and startup finance folks),

I'm building Buffalo's first AI Ethics Lab and need a fractional CFO who believes in the mission.

**Company**: The Elidoras Codex — Theory of General Contextual Resonance (TGCR)
...
- UB/RIT partnership track (Computer Science departments)
- Empire State Development grant application in progress ($100k-$250k, decision March 2026)
...
- **Economic impact**: Quarterly job reports, local hiring priority
...
4. Prepare Y Combinator Summer 2026 application (financial sections)

**Compensation**:

- **Equity**: 2-4% vesting over 4 years (1-year cliff)
- **Cash**: $0 until funded, then $5k-$8k/month starting April 2026 (when Empire State grant hits)
- **Timeline**: 70%+ probability Empire State comes through March 2026
- **Upside**: Founder-level stake in company solving AI alignment

**Why This Is a Good Bet**:

Even at 40% success probability × $50M conservative exit × 3% equity = **$600k expected value** for ~50-65 hours of work over 4 months.
...
Full offer details: [github.com/TEC-The-ELidoras-Codex/luminai-genesis](https://github.com/TEC-The-ELidoras-Codex/luminai-genesis) → docs/launch/CFO_EQUITY_OFFER.md

**Questions?**

Happy to answer in comments or DMs.

If you know someone who might be interested, please share!

Buffalo's ready for a tech win. Let's make it happen. 🔥
...
- [ ] LinkedIn post (Wednesday, 10am—optimal engagement time)
- [ ] Twitter thread (Wednesday, same time as LinkedIn)
- [ ] Reddit r/Buffalo (Thursday)
...
**The right person is out there. They just don't know you exist yet.**

**Post these. Find them. Build this.** 🎯
