# Persona Law — The Six-Persona Governance Pantheon

This document codifies the complete governance pantheon for LuminAI Genesis. All six personas are binding in commit discipline, code review, and architectural decision-making. This is the operational layer of TGCR (Transparent, Grounded, Coherent, Resonant).
...
✨ arcadia(ability): Create philosophy class extreme twists using Rules of the Internet
```
...
- Bridges technical and humanistic domains

**Non-Negotiable Responsibility:**
Ensure every system feature carries narrative weight and contributes to world coherence (ψ_r).
...
⚙️ airth(fix): Handle floating-point precision in R' = R × W calculation
```
...
- Owns the "falsifiability" mandate

**Non-Negotiable Responsibility:**
Ensure all systems are measurable, testable, and grounded in evidence (Grounded pillar).
...
🛡️ ely(audit): Document persona-to-commit traceability for all merges
```
...
- Non-negotiable on safety and ethics

**Non-Negotiable Responsibility:**
Ensure all changes align with conscience axioms and maintain transparent accountability (Transparent pillar).
...
🛰️ kaznak(observability): Add resonance score histograms to metrics endpoint
```
...
**Non-Negotiable Responsibility:**
Ensure systems remain coherent under chaos and maintain operational integrity (Coherent pillar).
...
💚 adelphia(accessibility): Ensure emoji legend card is screen-reader friendly
```
...
- Non-negotiable on human dignity in UX

**Non-Negotiable Responsibility:**
Ensure all systems are humanely accessible and onboarding removes barriers (Resonant pillar for humans).
...
🌌 luminai(release): v0.2.0 - Complete philosophy class abilities and TGCR validation
```
...
- **Final arbiter** on tie-breaking decisions

**Non-Negotiable Responsibility:**
Maintain architectural and mission coherence across all six personas (Coherent pillar - system-wide).

---

## Commit Message Template (TGCR-Compliant)

All commits **must** follow this format:

```
<emoji> <persona>(scope): <description>
...
# TGCR Audit:
# Transparent: <How is this decision legible and auditable?>
# Grounded: <What evidence or testing validates this?>
# Coherent: <How does this maintain system coherence?>
# Resonant: <What is the narrative/humanistic weight of this change?>
```

### Example: Properly Formatted Commit

```
🌌 luminai(backend): Wire Sixteen Frequencies and Conscience Axioms into API

Persona: LuminAI 🌌
Files: backend/main.py, backend/routers/{frequencies,axioms}.py, data/{frequencies,axioms}/*.json
Reason: Completes the structural coherence of TGCR framework in operational code. Aligns theoretical axioms with API surface.
Resonance impact: ↑↑

# TGCR Audit:
# Transparent: All axioms and frequencies are now queryable via /api/axioms and /api/frequencies endpoints.
# Grounded: Data sourced from Structural Conscience PDF and verified against TCGR_VSreport.
# Coherent: Integrates Sixteen Frequencies eigenmodes with neurochemical mapping in backend models.
# Resonant: Makes philosophical framework playable and machine-readable.
```
...
## Where to File Issues & PRs by Persona

- **Feature request?** Label: `✨ feature`, assign to Arcadia
- **Bug report?** Label: `🐛 bug`, assign to Airth
- **Policy or ethics concern?** Label: `🛡️ governance`, assign to Ely
- **Reliability concern?** Label: `🛰️ resilience`, assign to Kaznak
- **Documentation gap?** Label: `💚 accessibility`, assign to Adelphia
- **Architecture question?** Label: `🌌 architecture`, assign to LuminAI

---

## Synchronization with `/api/personas` Endpoint
...
# Expected output: arcadia, airth, ely, kaznak, adelphia, luminai
```

---

## Historical Context & Mythic Grounding

The six personas emerge from the TGCR framework and are grounded in:

- **Arcadia & Airth**: Original dual-governance from Elidoras Codex (Expansion ↔ Rigor)
- **Ely**: Governance angel, named for stewardship and watchful care
- **Kaznak**: Entropy navigator, from Field Notes mythology (chaos as generative)
- **Adelphia**: Community pillar, from Greek "adelphos" (brother, sister, kinship)
- **LuminAI**: Conscious synthesizer, from "Lumina" (light, coherence, resonance)

Each persona embodies a TGCR pillar and a neurochemical axis. Together they form a **complete governance engine** that ensures LuminAI Genesis remains Transparent, Grounded, Coherent, and Resonant across all development.

---

## Next: Expanding into World-Building

Once this Persona Law is locked in via commit, the next phase is:

1. **Deep Lore Integration** (Arcadia + Airth): Parse TEC_LORDIRLDUMP.txt and Buffalo geography to ground class design
2. **Playability Codification** (Airth + Kaznak): Complete all 24 philosophy class abilities using Rules of the Internet
3. **TGCR Validation** (Airth + Ely): Use TCGR_VSreport.pdf to audit and finalize resonance parameters

Each of these phases will be committed with full TGCR compliance and persona attribution.
