...
def build_party(enc: Dict[str, Any], codex: Dict[str, Any], ability_db: Dict[str, Any]) -> Dict[str, AstradigitalEntity]:
    ...
    for char in enc.get('party', []):
        entity = AstradigitalEntity.from_codex(char['name'], char['class'], codex, ability_db)
        party[entity.name] = entity
    return party


def build_enemies(enc: Dict[str, Any], codex: Dict[str, Any], ability_db: Dict[str, Any]) -> Dict[str, AstradigitalEntity]:
